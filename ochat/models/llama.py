...
""" PyTorch LLaMA model. With FlashAttention and Context Extension (through interpolating RoPE)"""
import math
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def __init__(self, config, extend_context_to=None):
        super().__init__(config)
        self.model = LlamaModel(config, extend_context_to=extend_context_to)
