...
def write_model(model_path, input_base_path, model_size, added_special_tokens, tokenizer_path=None, safe_serialization=True):
    ...
    tokenizer = write_tokenizer(model_path, tokenizer_path, added_special_tokens=added_special_tokens)
    ...
    if added_special_tokens:
        state_dict["model.embed_tokens.weight"] = add_tokens_to_embedding(added_special_tokens, state_dict["model.embed_tokens.weight"])
        state_dict["lm_head.weight"]            = add_tokens_to_embedding(added_special_tokens, state_dict["lm_head.weight"])
...
def write_tokenizer(tokenizer_path, input_tokenizer_path, added_special_tokens):
...
def main():
    ...
    if args.model_size != "tokenizer_only":
        ...
        write_tokenizer(args.output_dir, spm_path, added_special_tokens=args.added_special_tokens)
